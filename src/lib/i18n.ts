...
const translations = {
  en: {
    ...
    settings: {
      ...
      programLabel: 'Study Programme',
      programPlaceholder: 'Select your programme…',
  ...
  de: {
    ...
    settings: {
      ...
      deptPlaceholder: 'Wähle deinen Fachbereich…',
      programLabel: 'Studiengang',
      programPlaceholder: 'Wähle deinen Studiengang…',
