...
const SECURITY_HEADERS = {
  'Content-Security-Policy':
    "default-src 'self'; base-uri 'self'; object-src 'none'; frame-ancestors 'none'; form-action 'self'; img-src 'self' data: blob: https:; media-src 'self' data: blob: https:; font-src 'self' data: https:; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline' https://www.instagram.com https://www.tiktok.com; connect-src 'self' https: wss:; frame-src 'self' https:; worker-src 'self' blob:; upgrade-insecure-requests",
